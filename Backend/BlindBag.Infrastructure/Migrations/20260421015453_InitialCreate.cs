    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BlindBags", x => x.Id);
                    table.ForeignKey(
                        name: "FK_BlindBags_Category",
                        column: x => x.CategoryId,
                        principalTable: "Categories",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_BlindBags_Seller",
                        column: x => x.SellerId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ExternalResponseCode = table.Column<string>(type: "nvarchar(10)", maxLength: 10, nullable: true),
                    ExternalBankCode = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PayReq_Wallet",
                        column: x => x.WalletId,
                        principalTable: "Wallets",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_PayReq_WalletTransaction",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BlindBags_CategoryId",
                table: "BlindBags",
                column: "CategoryId");

            migrationBuilder.CreateIndex(
                name: "IX_BlindBags_SellerId",
                table: "BlindBags",
                column: "SellerId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PaymentRequests_ExternalTransactionId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PaymentRequests_WalletTransactionId",
                table: "PaymentRequests",
                column: "WalletTransactionId");

            migrationBuilder.CreateIndex(
                name: "IX_Reviews_BlindBagId",
                table: "Reviews",
                column: "BlindBagId");
